  ...
  return (
    <>
      ...
      <div className="text-gray-400 mb-8 text-lg">
        ...
        Manager for IDEA Public Schools. Currently managing a team of an
        Application Admin, Data Analyst, and a Help Desk Clerk team to
        administrate 4 Student Information Systems (SIS) in 4 different states
        with a grand total of over 9,000 school admins and 80,000 students.
