...
const projectsData: Project[] = [
  {
    ...
    description: "Enterprise automation system that automatically created user accounts for over 15,000 users across multiple Student Information Systems, eliminating manual provisioning.",
    longDescription: "Developed a comprehensive user provisioning automation that processes new student and staff data from HR systems and automatically creates accounts across 4 different SIS platforms. The system handles role assignments, security groups, and compliance requirements while maintaining 99.9% accuracy.",
    technologies: [
    ...
    features: [
      "Automated account creation for 15,000+ users",
      "Multi-platform SIS integration (4 different systems)",
      "Role-based access control and security group assignment",
      "Real-time error handling and notification system",
  ...
  },
  {
    ...
    longDescription: "As a critical member of the emergency response team, helped architect and implement the complete digital transformation that took IDEA Public Schools fully online during the COVID-19 pandemic. Managed system scaling, user provisioning, and technical support for the largest remote learning deployment in the organization's history.",
    technologies: [
    ...
    features: [
      ...
      "Emergency user provisioning and access management",
      "24/7 technical support coordination",
